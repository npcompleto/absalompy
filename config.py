...
HAILO_MODEL_PATH = os.getenv("HAILO_MODEL_PATH", "models/whisper_small.hef")
HAILO_MODEL_URL = os.getenv("HAILO_MODEL_URL", "https://dev-public.hailo.ai/v5.3.0/blob/Whisper-Small.hef")
